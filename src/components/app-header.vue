<template>
  <m-navbar :theme="theme.theme.headerTheme">
    ...
    <!--<m-nav>
      <m-nav-item><a href="https://www.4madeus.com" target="_blank">主页</a></m-nav-item>
      <m-nav-item><a href="https://blog.4madeus.com" target="_blank">博客</a></m-nav-item>
      <m-nav-item><a href="https://www.4madeus.com" target="_blank">关于</a></m-nav-item>
    </m-nav>-->
    <m-nav align="right">
      <!--<m-nav-item padding="0">
        <a href="https://github.com/CreamColored" target="_blank"><i class="fab fa-github"
                                                                     style="font-size: 26px;vertical-align: middle;"></i>&nbsp;Github</a>
      </m-nav-item>-->
      <m-nav-item padding="0">
        <m-dropdown align="right" v-if="admin!=null" padding="0 10px">
          <a href="#" style="display: inline-block; padding: 0px; color: inherit">
            ...
            <span>{{$store.state.admin.name}}</span>
